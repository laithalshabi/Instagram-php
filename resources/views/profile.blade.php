<x-app-layout>
        ...
        <header>
            <div class="grid grid-cols-5 gap-4">
                <div class="col-start-2 col-span-1 flex justify-center w-auto mt-5">
                    <img src="{{ $profile->profile_photo_url }}" class=" w-40 h-40 object-cover rounded-full">
                </div>
                <div class="col-start-3 col-span-2 flex justify-center items-center w-auto m-0">
                    <div class="grid grid-rows-2">
                        <div class="flex flex-row items-center">
                            <h1 class="font-light text-3xl me-14">{{ $profile->username }}</h1>
                            @if (Auth::user()!=null && Auth::user()->username==$profile->username)
    ...
    <div class="max-w-4xl my-0 mx-auto">
        ...
        <div class="grid grid-cols-3 gap-4 mx-0 mt-0 mb-6">
            ...
            <div class="post">
                <a href="/posts/{{ $post->id }}" class="w-full h-full">
                    <img src="/storage/{{ $post->img_path }}" class="w-full h-full object-cover">
                    <div class="post-info">
                        <ul>
        ...
        <div>
            ...
            <p class=" text-center">{{ __("Follow to their posts") }}</p>
        </div>
        @endcan
        @endif
    </div>
