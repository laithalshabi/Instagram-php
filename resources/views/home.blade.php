    ...
    <div class="grid grid-cols-12 mt-7 gap-4">
            ...
            <div class="flex flex-col border border-solid border-gray-300 mb-14 bg-white">
                <div class="flex flex-row p-3 border-b border-solid border-gray-300 items-center">
                    <a href="/{{$post->user->username}}">
                        <img src="{{ $post->user->profile_photo_url }}" class="rounded-full h-12 w-12 me-3 ">
                    </a>
                    <a href="/{{$post->user->username}}" class="hover:underline">{{$post->user->username}}</a>
                </div>
                <div>
                    <a href="/posts/{{$post->id}}"><img class="w-full" src="/storage/{{$post->img_path}}"> </a>
                </div>
        ...
        <div class="col-start-8 col-span-3 ms-4">
            <div class="flex flex-row items-center">
                <a href="/{{$profile->username}}"><img src="{{ $profile->profile_photo_url }}" class="rounded-full h-12 w-12 me-3 "></a>
